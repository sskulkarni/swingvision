...
while True:
    ...
    gray = cv2.equalizeHist(gray)  # Improves contrast of white lines
    ...
    if len(filtered_lines) >= 3:
        ...
        if convex.geom_type == 'Polygon':
            court_polygon = convex.buffer(60)  # Expand the polygon by 20 pixels (adjust as needed)
